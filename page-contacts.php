                    ...
                    <div class="contacts__phones">
                        <div class="contacts__phoneblock">
                            ...
                            <div class="contacts__phonewrap">
                                ...
                                <a href="<?php echo "tel:"; the_field('contacts_phone_1'); ?>"><?php the_field('contacts_phone_1'); ?></a>
                            </div>
                        </div>
                        <div class="contacts__phoneblock">
                            Телефон №2
                            <div class="contacts__phonewrap">
                                ...
                                <a href="<?php echo "tel:"; the_field('contacts_phone_2'); ?>"><?php the_field('contacts_phone_2'); ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="contacts__mail">
                        Или напишите нам на почту
                        <a href="<?php the_field('mail'); ?>" class="header__contacts-mail"><?php the_field('contacts_mail'); ?></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
