<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode('[contact-form-7 id="159" title="Форма вопроса"]'); ?>
                <!-- <form action="#">
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    <a href="<?php echo "tel:"; the_field('main_tel', 2); ?>"><?php the_field('main_tel', 2); ?></a>
                                    <a href="<?php echo "tel:"; the_field('add_tel', 2); ?>"><?php the_field('add_tel', 2); ?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
